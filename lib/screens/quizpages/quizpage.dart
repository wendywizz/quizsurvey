...
import 'package:quizsurvey/screens/quizpages/resultpage.dart';
      ...
      onWillPop: () {
        return showDialog(
          ...
          builder: (context) => AlertDialog(
            title: Text("Wow Such Quiz"),
            content: Text("You can't pussy out now."),
            actions: <Widget>[
              TextButton(
                onPressed: () {
        ...
        body: DecoratedBox(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
                image: AssetImage('images/renback.jpg'), fit: BoxFit.cover),
          ),
          child: Column(
            children: <Widget>[
              Expanded(
